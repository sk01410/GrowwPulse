    ...
    <div className="min-h-screen flex flex-col justify-center items-center px-4 py-12 bg-[#F8F9FA]">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-[#1F2937] tracking-tight">Create your account</h2>
          <p className="mt-1.5 text-sm text-[#6B7280]">Start tracking temporal movements on your watchlist</p>
        </div>
        ...
        <div className="groww-card p-8 rounded-2xl shadow-sm bg-white border border-[#E5E7EB]">
          ...
          <div className="mt-6 pt-6 border-t border-[#E5E7EB] text-center text-xs text-[#6B7280]">
            ...
            <Link href="/login" className="text-[#00B386] hover:underline font-bold">
              Sign in
            </Link>
          </div>
        </div>
