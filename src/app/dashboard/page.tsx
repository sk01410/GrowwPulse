    ...
    const demoRankedEvents: PulseEvent[] = [
      {
        ...
        referencePrice: 1245.0,
        evaluationPrice: 1298.5,
        return: 53.5,
        returnPercent: 4.30,
        expectedMovement: 18.0,
        expectedMovementPercent: 1.45,
        unusualness: 3.82,
        attentionLevel: 'HIGH_ATTENTION',
        confidence: 'HIGH',
        explanation: 'Sharp price appreciation (+4.30%) exceeds expected volatility (±1.45%) by 3.82× standard deviations with heavy institutional volume.',
        whySurfaced: 'Price increased 4.30% (3.82× expected interval volatility)',
        ...
        sectorContext: {
          ...
          idiosyncraticDivergence: 3.10,
          isSectorWide: false,
          relativeNarrative: 'Company-specific alpha: RELIANCE gained +4.30% vs Nifty Energy (+1.20%), delivering +3.10% idiosyncratic divergence.',
        },
        provenance: {
